...
{ // 添加extern "C"
	...
	public:
		...
		// // float jr1[7] = {-2, -1.57, -1, -2, -1, -1.4, -0.7}; // �ؽھ�̬�Ƕȷ�Χ
		// // float jr2[7] = {0.5, 0, 1.57, 0, 1.57, 0.5, 2};
		// float jr1[7] = {-2, -1.57, -1.3, -2, -1.3, -1.4, -1.1}; // �ؽھ�̬�Ƕȷ�Χ
		// float jr2[7] = {0.9, 0.9, 1.57, 0.9, 1.57, 0.9, 2};
		float gap0, gap;
		float ypr[6] = {0, 0, 0};
		// float j[7] = {0, 0, 0, 0, 0, 0, 0};
		void showpointsinfo();
	...
	protected:
		...
		void init_arm_structure()
		{
			...
			// rod[0].r = 10, rod[1].r = 10, rod[2].r = 10;	// 连杆半径 卡诺普65
			// rod[0].l = 181, rod[1].l = 240, rod[2].l = 229; // 连杆长度 卡诺普65
			init_rodindex();
		}
		// 初始化数学模型参数
