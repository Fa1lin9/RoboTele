...
VisionPro2UnitreeG1Transform::VisionPro2UnitreeG1Transform(const Transform::BasicConfig &config_)
...
VisionPro2UnitreeG1Transform::~VisionPro2UnitreeG1Transform(){

}

std::vector<Eigen::Matrix4d> VisionPro2UnitreeG1Transform::Solve(
